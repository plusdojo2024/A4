...
(
    ...
    user_password INTEGER(100), /*パスワード*/
    user_name VARCHAR(100), /*ユーザーネーム*/
    user_img VARCHAR, /*アイコン画像*/
    privcy_flg INTEGER, /*公開・非公開フラグ*/
...
(
    ...
    category1_name VARCHAR(100), /*大カテゴリー名*/
    created_at INTEGER(100), /*作成日時*/
    updated_at VARCHAR(100), /*更新日時*/
...
(
    ...
    category2_name VARCHAR(100), /*小カテゴリー名*/
    created_at VARCHAR, /*作成日時*/
    updated_at VARCHAR, /*更新日時*/
...
(
    ...
    review_name VARCHAR(100), /*レビュー名*/
    review_price INTEGER, /*レビュー価格*/
    review_comment VARCHAR(100), /*レビューコメント*/
    user_id INTEGER, /*ユーザーID*/
    privacy_flg INTEGER, /*公開・非公開フラグ*/
    delete_flg INTEGER, /*削除フラグ*/
    created_at VARCHAR, /*作成日時*/
    updated_at VARCHAR, /*更新日時*/
...
(
    ...
    review_id INTEGER, /*レビューID*/
    backnumber_content VARCHAR(100), /*バックナンバーコンテンツ*/
    delete_flg INTEGER, /*削除フラグ*/
    created_at VARCHAR, /*作成日時*/
    updated_at VARCHAR, /*更新日時*/
